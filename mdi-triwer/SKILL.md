...
metadata: "v1.0.1 — julho 2026 — adiciona verificação automática de versão no BOOT (ver CHANGELOG.md). v1.0 — julho 2026 — adaptado do agente MDI (GPT) original"
---
...
`https://raw.githubusercontent.com/paulovyn1/triwer-skills/main/mdi-triwer/CHANGELOG.md`
...
- **Remota mais nova, sem tag `[CRITICAL]`:** avise em uma linha, ex.: "💡 Há
  uma versão nova da mdi-triwer disponível (v[local] → v[remota]). Não é
...
- **Remota mais nova, com tag `[CRITICAL]`:** pare aqui. Explique em 2-3
  ...
  como atualizar:
  - **Claude Code/Desktop:** `irm https://raw.githubusercontent.com/paulovyn1/triwer-skills/main/scripts/instalar-mdi-windows.ps1 | iex` (Windows) ou `curl -fsSL https://raw.githubusercontent.com/paulovyn1/triwer-skills/main/scripts/instalar-mdi-mac.sh | bash` (Mac/Linux).
