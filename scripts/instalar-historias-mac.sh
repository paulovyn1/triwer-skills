...
# =============================================================
# Triwer Skills — Instalador do historias-triwer (Mac e Linux)
# =============================================================
...
VERSION_URL="$REPO/historias-triwer/VERSION"
...
echo ""
echo -e "${BLUE}╔══════════════════════════════════════╗${NC}"
echo -e "${BLUE}║   Triwer Skills — historias-triwer   ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════╝${NC}"
echo ""
...
mkdir -p "$HISTORIAS_DIR"

# Baixar arquivos principais
echo -e "${YELLOW}→ Baixando historias-triwer...${NC}"
download_file "historias-triwer/SKILL.md" "$HISTORIAS_DIR/SKILL.md"

# memoria.md: nunca sobrescrever se já existir
if [ ! -f "$HISTORIAS_DIR/memoria.md" ]; then
...
echo ""
echo -e "  2. Não precisa rodar por comando — a partir daqui, sempre que"
echo -e "     você contar um caso real numa conversa, esta skill considera"
echo -e "     se vale oferecer cadastro"
echo ""
echo -e "  3. Para uso direto: digite ${YELLOW}/historias-triwer${NC}"
echo ""
