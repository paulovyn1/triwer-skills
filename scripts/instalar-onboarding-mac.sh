...
# =============================================================
# Triwer Skills — Instalador do onboarding-triwer (Mac e Linux)
# =============================================================
#
...
VERSION_URL="$REPO/onboarding-triwer/VERSION"
...
echo ""
echo -e "${BLUE}╔══════════════════════════════════════╗${NC}"
echo -e "${BLUE}║   Triwer Skills — onboarding-triwer  ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════╝${NC}"
echo ""
...
echo -e "${YELLOW}→ Baixando onboarding-triwer...${NC}"
download_file "onboarding-triwer/SKILL.md" "$ONBOARDING_DIR/SKILL.md"

# memoria.md: nunca sobrescrever se já existir
if [ ! -f "$ONBOARDING_DIR/memoria.md" ]; then
...
echo -e "  1. Conecte o Notion no seu cliente Claude (instruções dentro da"
echo -e "     própria skill, ela te orienta se detectar que falta)"
echo ""
echo -e "  2. Abra uma nova conversa"
echo -e "     e digite: ${YELLOW}/onboarding-triwer${NC}"
echo ""
echo -e "  3. Siga o fluxo — leva de 5 a 10 minutos."
echo ""
