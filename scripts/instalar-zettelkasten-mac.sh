...
# =============================================================
# Triwer Skills — Instalador do notion-zettelkasten-si (Mac e Linux)
# =============================================================
#
...
ZETTEL_DIR="$SKILLS_DIR/notion-zettelkasten-si"
VERSION_URL="$REPO/notion-zettelkasten-si/VERSION"
...
echo ""
echo -e "${BLUE}╔══════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║   Triwer Skills — notion-zettelkasten-si ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════╝${NC}"
echo ""
...
mkdir -p "$ZETTEL_DIR/references"

# Baixar arquivos principais
echo -e "${YELLOW}→ Baixando notion-zettelkasten-si...${NC}"
download_file "notion-zettelkasten-si/SKILL.md" "$ZETTEL_DIR/SKILL.md"
download_file "notion-zettelkasten-si/references/diagramacao.md" "$ZETTEL_DIR/references/diagramacao.md"

# memoria.md: nunca sobrescrever se já existir
if [ ! -f "$ZETTEL_DIR/memoria.md" ]; then
...
echo ""
echo -e "  2. Não precisa rodar por comando — sempre que você pedir para"
echo -e "     salvar algo no Notion, esta skill entra em ação"
echo ""
